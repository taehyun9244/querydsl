...
//                .fetchFirst();
    ...
    public void dynamicQuery_BooleanBuilder(){
        ...
        List<Member> result = searchMemnber1(usernameParam, ageParam);
        assertThat(result.size()).isEqualTo(1);

    }

    private List<Member> searchMemnber1(String usernameCond, Integer ageCond) {
    ...
    public void bulkUpdate(){
        ...
        List<Member> afterResult = queryFactory
                .selectFrom(member)
                .fetch();
        for (Member member1 : afterResult) {
            System.out.println("member1 = " + member1);
        }
    }
    // 뺴기는 존재하기 않기 때문에 -1를 넣어주면 된다 add(-1)
    @Test
    public void bulkAdd(){
        long count = queryFactory
                .update(member)
